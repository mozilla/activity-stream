...
is exported to Mozilla central on a regular basis, which can be found at [browser/extensions/activity-stream/system-addon](https://searchfox.org/mozilla-central/source/browser/extensions/activity-stream/system-addon).
...
into the `browser/extensions/activity-stream/system-addon` directory inside Mozilla Central.
