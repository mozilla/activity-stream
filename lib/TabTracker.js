...
function TabTracker(trackableURLs, clientID) {
  ...
  if (this.enabled) {
    ...
    Services.obs.addObserver(this.onLoadComplete, "performance-log-complete");
  }
...
TabTracker.prototype = {
  ...
  _removeListeners() {
    ...
    Services.obs.removeObserver(this.onLoadComplete, "performance-log-complete");
  },
  ...
  onLoadComplete: function(subject, topic, data) {
