...
Links.prototype = {
  ...
  getRecentLinks: Task.async(function*(options) {
    ...
    let sqlQuery =  `SELECT moz_places.url as url, moz_favicons.data as favicon, mime_type, title,
                            frecency, last_visit_date as lastVisitDate,  "history"  as type
                     FROM moz_places
    ...
    let links = yield this.executePlacesQuery(sqlQuery, {
                  columns: ["url", "favicon", "mime_type", "title", "lastVisitDate", "frecency", "type"],
                  params: {limit: limit}
                });
  ...
  getRecentBookmarks: Task.async(function*(options={}) {
    ...
    let links = yield this.executePlacesQuery(sqlQuery, {
                  columns: ["bookmarkId", "bookmarkTitle", "bookmarkGuid", "url", "title", "lastVisitDate", "frecency", "type", "lastModified", "favicon", "mime_type"],
                  params: {limit}
                });
   ...
   *
   * @param {Array} links
   *            an array containing objects with favicon data and mime_types
   *
