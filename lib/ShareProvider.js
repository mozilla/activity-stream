  ...
  return {
    ...
    value: {
      ...
      sharePage: (providerOrigin, graphData, target) => {
        ...
        // HACK: FIXME: there is a bug with gmail where we end up with a 1px window that
        // can't be closed. Force the dimensions to 500x500.
        if (provider.origin === "https://mail.google.com") {
          features = `${features},innerWidth=500,innerHeight=500`;
        }
