...
ShareProvider.prototype = {
  ...
  uninit: Task.async(function*(reason) {
    Services.obs.removeObserver(this._button, "social:providers-changed");
    CustomizableUI.removeListener(this._button);
    CustomizableUI.destroyWidget(this._button.id);
