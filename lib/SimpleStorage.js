...
/* This is a direct copy from addon sdk as activity stream wants to increase
 * the default quota (5M) of simple-storage. Increasing the one in addon
 * sdk will also affect other installed addons, which results in unnecessary
...
const SIMPLE_STORAGE_WRITE_PERIOD = "as-simple-storage.writePeriod";
// const WRITE_PERIOD_DEFAULT = 300000; // 5 minutes

const SIMPLE_STORAGE_QUOTA = "as-simple-storage.quota";
// const QUOTA_DEFAULT = 20971520; // 20 MiB
...
var manager = ({
  ...
  get filename() {
    ...
    storeFile.append("as-simple-storage");
  ...
  new: function manager_constructor() {
    ...
    manager.jsonStore = new JsonStore({
      ...
      writePeriod: simplePrefs.prefs[SIMPLE_STORAGE_WRITE_PERIOD],
      quota: simplePrefs.prefs[SIMPLE_STORAGE_QUOTA],
