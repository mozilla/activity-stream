...
The variable properties in a use event ping include some variable feels which indicate the location and action of the event, as well as some basic metadata.
