...
const QUOTA_PREF = "extensions.@activity-streams.as-simple-storage.quota"
...
function manager(loader) {
  return loader.sandbox(REQUIRE_SS_PATH).manager;
}

exports.testSetGet = function (assert, done) {
  // Load the module once, set a value.
  let loader = Loader(module);
  let ss = loader.require(REQUIRE_SS_PATH);
  manager(loader).jsonStore.onWrite = function (storage) {
    ...
    ss = loader.require(REQUIRE_SS_PATH);
    manager(loader).jsonStore.onWrite = function (storage) {
