...
exports.test_only_request_links_once = function*(assert) {
  const msg1 = [{"url": "a.com", "sanitizedURL": "a.com", "cache_key": "a.com"},
                {"url": "b.com", "sanitizedURL": "b.com", "cache_key": "b.com"},
                {"url": "c.com", "sanitizedURL": "c.com", "cache_key": "c.com"}];

  const msg2 = [{"url": "b.com", "sanitizedURL": "b.com", "cache_key": "b.com"},
                {"url": "c.com", "sanitizedURL": "c.com", "cache_key": "c.com"},
                {"url": "d.com", "sanitizedURL": "d.com", "cache_key": "d.com"}];
...
exports.test_process_links = function*(assert) {
  ...
  processedLinks.forEach((link, i) => {
    ...
    assert.ok(link.sanitizedURL, "link has a sanitized url");
...
exports.test_throw_out_non_requested_responses = function*(assert) {
  const fakeSite1 = {"url": "http://example1.com/", "sanitizedURL": "http://example1.com/", "cache_key": "example1.com/"};
  const fakeSite2 = {"url": "http://example2.com/", "sanitizedURL": "http://example2.com/", "cache_key": "example2.com/"};
  const fakeSite3 = {"url": "http://example3.com/", "sanitizedURL": "http://example3.com/", "cache_key": "example3.com/"};
  const fakeSite4 = {"url": "http://example4.com/", "sanitizedURL": "http://example4.com/", "cache_key": "example4.com/"};
  // send site 1, 2, 4
...
exports.test_get_enhanced_previews_only = function*(assert) {
  gMetadataStore[0] = {sanitizedURL: "http://example.com/", cache_key: "example.com/", url: "http://example.com/"};
  let links;
