...
describe("<TopSite>", () => {
  ...
  it("should render a TopSite", () => {
    const wrapper = shallow(<TopSite link={link} intl={DEFAULT_PROPS.intl} />);
    assert.ok(wrapper.exists());
  });
  ...
  it("should have .active class, on top-site-outer if context menu is open", () => {
    const wrapper = shallow(<TopSite link={link} index={1} activeIndex={1} intl={DEFAULT_PROPS.intl} />);
  ...
  it("should not add .active class, on top-site-outer if context menu is closed", () => {
    const wrapper = shallow(<TopSite link={link} index={1} intl={DEFAULT_PROPS.intl} />);
  ...
  describe("#onLinkClick", () => {
    it("should call dispatch when the link is clicked", () => {
      ...
      const wrapper = shallow(<TopSite link={link} index={3} dispatch={dispatch} intl={DEFAULT_PROPS.intl} />);
    ...
    it("should dispatch a UserEventAction with the right data", () => {
      const dispatch = sinon.stub();
      const wrapper = shallow(<TopSite link={Object.assign({}, link, {iconType: "rich_icon", isPinned: true})} index={3} dispatch={dispatch} intl={DEFAULT_PROPS.intl} />);
    ...
    it("should dispatch a UserEventAction with the right data for search top site", () => {
      ...
      const wrapper = shallow(<TopSite link={Object.assign({}, link, siteInfo)} index={3} dispatch={dispatch} intl={DEFAULT_PROPS.intl} />);
    ...
    it("should dispatch OPEN_LINK with the right data", () => {
      const dispatch = sinon.stub();
      const wrapper = shallow(<TopSite link={Object.assign({}, link, {typedBonus: true})} index={3} dispatch={dispatch} intl={DEFAULT_PROPS.intl} />);
