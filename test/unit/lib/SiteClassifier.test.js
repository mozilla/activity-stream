...
describe("SiteClassifier", () => {
  ...
  it("should return the right category", async () => {
    ...
    assert.equal("params-match", await classifySite("https://example.com?param1=val1&param2=val2", RemoteSettings));
    assert.equal("params-match", await classifySite("https://example.com?param1=val1&param2=val2&other=other", RemoteSettings));
