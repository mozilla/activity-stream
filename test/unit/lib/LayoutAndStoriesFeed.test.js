...
import injector from "inject!lib/LayoutAndStoriesFeed.jsm";

describe("Layout and Stories Feed", () => {
  let LayoutAndStoriesFeed;
  ...
  beforeEach(() => {
    ...
    ({
      ...
      "lib/PersonalityProvider.jsm": {PersonalityProvider: FakePersonalityProvider},
      "lib/UserDomainAffinityProvider.jsm": {UserDomainAffinityProvider: FakeUserDomainAffinityProvider},
      "lib/SectionsManager.jsm": {SectionsManager: sectionsManagerStub},
    }));

    instance = new LayoutAndStoriesFeed();
  ...
  describe("#init", () => {
    it("should create a LayoutAndStoriesFeed", () => {
      assert.instanceOf(instance, LayoutAndStoriesFeed);
    });
