...
describe("ASRouter", () => {
  ...
  describe("#overrideOrEnableLegacyOnboarding", () => {
    it("should set the onboarding finished pref to true if it is false and ASRPreferences.allowLegacyOnboarding is false", async () => {
  ...
  describe("#_updateMessageProviders", () => {
    ...
    it("should not add snippets if legacy onboarding is not finished", () => {
      sandbox.stub(ASRouterPreferences, "specialConditions").get(() => ({allowLegacySnippets: true, onboardingFinished: false}));
      const providers = [
