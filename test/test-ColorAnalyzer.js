...
const CA = require("addon/ColorAnalyzer");
...
exports["test simple"] = (function* test_redSquare() {
...
exports["test blue overlapping eed"] = (function* test_blueOverlappingRed() {
  yield canvasTest(16, 16, function(ctx) {
    ctx.fillStyle = "red";
...
exports["test red gradient blue solid"] = (function* test_redGradientBlueSolid() {
  yield canvasTest(16, 16, function(ctx) {
...
exports["test dominant colors"] = (function* test_transparent() {
  yield canvasTest(16, 16, function(ctx) {
    //do nothing!
  }, null, "transparent analysis fails");
});

exports["test invalid URI"] = (function* test_invalidURI() {
  yield frcTest("data:blah,Imnotavaliddatauri", null, "invalid URI analysis fails");
});

exports["test malformed PNG"] = (function* test_malformedPNGURI() {
  yield frcTest("data:image/png;base64,iVBORblahblahblah", null,
                "malformed PNG URI analysis fails");
});

exports["test unresolvable URI"] = (function* test_unresolvableURI() {
...
exports["test blue on red"] = (function* test_blueOnRedBackground() {
  yield canvasTest(16, 16, function(ctx) {
    ctx.fillStyle = "red";
    ctx.fillRect(0, 0, 16, 16);
    ctx.fillStyle = "blue";
...
exports["test variable BG"] = (function* test_variableBackground() {
  yield canvasTest(16, 16, function(ctx) {
    ctx.fillStyle = "white";
    ctx.fillRect(0, 0, 16, 16);
...
exports["test too variable bg"] = (function* test_tooVariableBackground() {
  yield canvasTest(16, 16, function(ctx) {
    ctx.fillStyle = "white";
    ctx.fillRect(0, 0, 16, 16);
...
exports["test transparent BG"] = (function* test_transparentBackgroundConflation() {
  yield canvasTest(16, 16, function(ctx) {
    ctx.fillStyle = "black";
    ctx.fillRect(2, 2, 12, 12);
    ctx.fillStyle = "white";
...
exports["test bg fallback"] = (function* test_backgroundFallback() {
  yield canvasTest(16, 16, function(ctx) {
    ctx.fillStyle = "black";
    ctx.fillRect(0, 0, 16, 16);
...
exports["test color prefs"] = (function* test_interestingColorPreference() {
  yield canvasTest(16, 16, function(ctx) {
...
exports["test saturation dep"] = (function* test_saturationDependence() {
  yield canvasTest(16, 16, function(ctx) {
...
exports["test interestingColorPreferenceLenient"] = (function* test_interestingColorPreferenceLenient() {
  yield canvasTest(16, 16, function(ctx) {
    ctx.fillStyle = "black";
...
exports["test interestingColorPreferenceNotTooLenient"] = (function* test_interestingColorPreferenceNotTooLenient() {
  yield canvasTest(16, 16, function(ctx) {
    ctx.fillStyle = "black";
    ctx.fillRect(1, 1, 13, 13);
    ctx.fillStyle = "red";
...
exports["test image too large"] = (function* test_imageTooLarge() {
