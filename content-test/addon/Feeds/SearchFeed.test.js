...
describe("SearchFeed", () => {
  ...
  describe("#onAction", () => {
    ...
    it("should call getEngines on a new tab", () => {
      instance.onAction({}, {type: "OPEN_NEW_TAB"});
      assert.calledOnce(instance.getEngines);
    });
    it("should call getEngines on SEARCH_CURRENT_ENGINE_UPDATED", () => {
      instance.onAction({}, {type: "SEARCH_CURRENT_ENGINE_UPDATED"});
      assert.calledOnce(instance.getEngines);
    });
  });
});
