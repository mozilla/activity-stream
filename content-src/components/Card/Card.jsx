        ...
        >
          <div className="card">
            ...
            <div className="card-details">
              {link.type === "download" && (
                <div className="card-host-name alternate">
                  <FormattedMessage
                    id={GetPlatformString(this.props.platform)}
                  />
                </div>
              )}
              {link.hostname && (
              ...
              <div className="card-context">
                ...
                {intlID && !link.context && (
                  <div className="card-context-label">
                    <FormattedMessage id={intlID} defaultMessage="Visited" />
                  </div>
                )}
                {link.context && (
        ...
        {!props.placeholder && (
          ...
          >
            <span
              aria-haspopup="true"
              className="sr-only"
            >{`Open context menu for ${link.title}`}</span>
          </button>
        )}
        {isContextMenuOpen && (
          <LinkMenu
