...
export class _Card extends React.PureComponent {
  ...
  render() {
    ...
    return (<li className={outerClassName}>
      ...
      {!props.placeholder && <button aria-haspopup="true" aria-label={this.props.intl.formatMessage({id: "context_menu_button_sr"}, {title})} className="context-menu-button icon" title={this.props.intl.formatMessage({id: "context_menu_title"})}
