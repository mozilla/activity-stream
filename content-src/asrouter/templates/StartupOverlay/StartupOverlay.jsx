...
export class _StartupOverlay extends React.PureComponent {
  ...
  render() {
    ...
    let termsLink = (
      ...
      >
        <FormattedMessage id="firstrun_terms_of_service" />
      </a>
    );
    let privacyLink = (
      <a
        ...
        rel="noopener noreferrer"
      >
        <FormattedMessage id="firstrun_privacy_notice" />
      </a>
    );
          ...
          <div className="fxaccounts-container">
            <div className="firstrun-left-divider">
              <h1 className="firstrun-title">
                <FormattedMessage id="firstrun_title" />
              </h1>
              <p className="firstrun-content">
                <FormattedMessage id="firstrun_content" />
              </p>
              <a
                ...
                rel="noopener noreferrer"
              >
                <FormattedMessage id="firstrun_learn_more_link" />
              </a>
            </div>
            <div className="firstrun-sign-in">
              <p className="form-header">
                <FormattedMessage id="firstrun_form_header" />
                <span className="sub-header">
                  <FormattedMessage id="firstrun_form_sub_header" />
                </span>
              </p>
              <form
                method="get"
              ...
              >
                ...
                <button className="continue-button" type="submit">
                  <FormattedMessage id="firstrun_continue_to_login" />
                </button>
              </form>
              <button
              ...
              >
                <FormattedMessage id="firstrun_skip_login" />
              </button>
            </div>
          </div>
        </div>
